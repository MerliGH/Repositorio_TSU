...
<!--MENU-->
    ...
    if ($contrasenaUsuario !== null) {
        ...
        if ($datosUsuario != "Wrong" && mysqli_num_rows($datosUsuario) > 0) {
            ...
            ?>
            <div class="user-info">
            <form method="post" action="AddupdateUser.php"> <!-- Agregado: Inicio del formulario -->
            <table>
                <tr>
                    <td>Nombre de usuario:</td>
                    <td><input type="text" name="txtUser" value="<?php echo $infoUsuario['nombreUser']; ?>" readonly></td>
                </tr>

                <tr>
                    <td>Nombre nuevo:</td>
                    <td><input type="text" name="txtNewUser" placeholder="Ingrese el nuevo nombre"></td>
                </tr>
             </table>
