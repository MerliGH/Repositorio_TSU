...
<!--MENU-->
    ...
    if ($contrasenaUsuario !== null) {
        ...
        if ($datosUsuario != "Wrong" && mysqli_num_rows($datosUsuario) > 0) {
            ...
            ?>
            <div class="user-info">
            <form method="post" action="AddupdateEmpresa.php"> <!-- Agregado: Inicio del formulario -->
            <table>
                <tr>
                    <td>Empresa actual</td>
                    <td><input type="text" name="txtEmp" value="<?php echo $infoUsuario['nombreEmpresa']; ?>" readonly></td>
                </tr>

                <tr>
                    <td>Empresa nueva:</td>
                    <td><input type="text" name="txtNewEmp" placeholder="Ingrese nueva compania donde labora."></td>
                </tr>
             </table>
