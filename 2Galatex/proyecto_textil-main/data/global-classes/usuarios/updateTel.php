...
<!--MENU-->
    ...
    if ($contrasenaUsuario !== null) {
        ...
        if ($datosUsuario != "Wrong" && mysqli_num_rows($datosUsuario) > 0) {
            ...
            ?>
            <div class="user-info">
            <form method="post" action="AddupdateTel.php"> 
            <table>
                <tr>
                    <td>Correo actual</td>
                    <td><input type="text" name="txtTel" value="<?php echo $infoUsuario['telContact']; ?>" readonly></td>
                </tr>

                <tr>
    <td>Tel corregido:</td>
    <td><input type="number" name="txtNewTel" placeholder="Ingrese nuevo telefono" required></td>
</tr>
