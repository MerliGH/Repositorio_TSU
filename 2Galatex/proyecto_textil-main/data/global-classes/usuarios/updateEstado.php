...
<!--MENU-->
    ...
    if ($contrasenaUsuario !== null) {
        ...
        if ($datosUsuario != "Wrong" && mysqli_num_rows($datosUsuario) > 0) {
            ...
            ?>
            <div class="user-info">
            <form method="post" action="AddupdateEstado.php"> <!-- Agregado: Inicio del formulario -->
            <form method="post" action="AddupdateEstado.php"> 
            <table>
                            <tr>
                                <td>Estado de cuenta actual: </td>
                                
                                <td><input type="text" name="txtEstado" value="<?php echo $infoUsuario['estado']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <td>Nombre usuario</td>
                                <td><input type="text" name="txtNombre" value="<?php echo $infoUsuario['nombreUser']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <td colspan="2">Una vez hecha la acción no se podrá deshacer.</td>
                            </tr>
                            <tr>
                                <td>¿Desea continuar?</td>
                                <td>
        ...
        <p><button type="submit" id="enviarFormulario" style="display: none;">Enviar formulario</button></p>
