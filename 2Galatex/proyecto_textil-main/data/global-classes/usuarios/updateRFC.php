...
<!--MENU-->
    ...
    if ($contrasenaUsuario !== null) {
        ...
        if ($datosUsuario != "Wrong" && mysqli_num_rows($datosUsuario) > 0) {
            ...
            ?>
            <div class="user-info">
            <form method="post" action="AddupdateRFC.php"> <!-- Agregado: Inicio del formulario -->
            <table>
                <tr>
                    <td>RFC actual</td>
                    <td><input type="text" name="txtRFC" value="<?php echo $infoUsuario['rfc']; ?>" readonly></td>
                </tr>

                <tr>
                    <td>RFC corregido:</td>
                    <td><input type="text" name="txtNewRFC" placeholder="Ingrese nuevo Registro Federal de Contribuyentes"></td>
                </tr>
             </table>
