...
<!--MENU-->
    ...
    if ($contrasenaUsuario !== null) {
        ...
        if ($datosUsuario != "Wrong" && mysqli_num_rows($datosUsuario) > 0) {
            ...
            ?>
            <div class="user-info">
            <form method="post" action="AddupdateCorreo.php"> 
            <table>
                <tr>
                    <td>Correo actual</td>
                    <td><input type="text" name="txtCorreo" value="<?php echo $infoUsuario['correo']; ?>" readonly></td>
                </tr>

                <tr>
                    <td>Correo corregido:</td>
                    <td><input type="text" name="txtNewCorreo" placeholder="Ingrese nuevo correo"></td>
                </tr>
             </table>
