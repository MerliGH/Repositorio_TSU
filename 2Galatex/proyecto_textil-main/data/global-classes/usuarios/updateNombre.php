...
<!--MENU-->
    ...
    if ($contrasenaUsuario !== null) {
        ...
        if ($datosUsuario != "Wrong" && mysqli_num_rows($datosUsuario) > 0) {
            ...
            ?>
            <div class="user-info">
            <form method="post" action="AddupdateNombre.php"> <!-- Agregado: Inicio del formulario -->
            <table>
                <tr>
                    <td>Nombre de contacto actual</td>
                    <td><input type="text" name="txtNombre" value="<?php echo $infoUsuario['nombreContacto']; ?>" readonly></td>
                </tr>

                <tr>
                    <td>Apellido actual</td>
                    <td><input type="text" name="txtapPat" value="<?php echo $infoUsuario['apPat']; ?>" readonly></td>
                </tr>

                <tr>
                    <td>Apellido actual</td>
                    <td><input type="text" name="txtapMat" value="<?php echo $infoUsuario['apMat']; ?>" readonly></td>
                </tr>

                <tr>
                    <td>Nombre nuevo:</td>
                    <td><input type="text" name="txtNewNombre" placeholder="Ingrese nuevo Registro Federal de Contribuyentes"></td>
                </tr>

                <tr>
                    <td>Nombre nuevo:</td>
                    <td><input type="text" name="txtNewapPat" placeholder="Ingrese nuevo Registro Federal de Contribuyentes"></td>
                </tr>

                <tr>
                    <td>Nombre nuevo:</td>
                    <td><input type="text" name="txtNewapMat" placeholder="Ingrese nuevo Registro Federal de Contribuyentes"></td>
                </tr>
