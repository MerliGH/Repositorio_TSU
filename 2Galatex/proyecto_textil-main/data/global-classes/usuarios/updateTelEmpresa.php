...
<!--MENU-->
    ...
    if ($contrasenaUsuario !== null) {
        ...
        if ($datosUsuario != "Wrong" && mysqli_num_rows($datosUsuario) > 0) {
            ...
            ?>
            <div class="user-info">
            <form method="post" action="AddupdateTelEmpresa.php"> <!-- Agregado: Inicio del formulario -->
            <table>
                <tr>
                    <td>Numero telefonico de la Empresa actual</td>
                    <td><input type="text" name="txtTelEmp" value="<?php echo $infoUsuario['telEmpresa']; ?>" readonly></td>
                </tr>
                <tr>
    <td>Numero telefonico actualizado:</td>
    <td><input type="tel" name="txtNewTelEmp" placeholder="Ingrese nuevo numero de contacto" pattern="[0-9]{10}" title="Ingrese un número de teléfono válido (10 dígitos)" required></td>
</tr>
